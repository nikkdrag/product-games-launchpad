      ...
      <div className="pg-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {cases.map((caseItem) => (
            <div 
              key={caseItem.id} 
              className="case-preview bg-white rounded-lg shadow-md overflow-hidden cursor-pointer animate-fade-in-up"
            ...
            >
              <div className="p-4 h-16 bg-pgpurple bg-opacity-10 flex items-center justify-center">
                <div className="w-10 h-10 bg-white rounded-lg shadow flex items-center justify-center">
                  {/* Placeholder for company logo - replace with actual logos */}
                  <span className="text-pgpurple font-semibold">{caseItem.logo.charAt(0).toUpperCase()}</span>
                </div>
              </div>
              
              <div className="p-6">
                <h3 className="font-semibold text-xl mb-3">{caseItem.title}</h3>
                <p className="text-gray-700 line-clamp-6 whitespace-pre-line">{caseItem.description}</p>
              </div>
            </div>
          ))}
        </div>
